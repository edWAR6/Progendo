...
function iPadSynchronization()
{
    ...
    serverErrors += SynchronizeLogInfo(VIDEO1_SCREEN_ID, RetrieveLogInfo(VIDEO1_SCREEN_ID));
    serverErrors += SynchronizeLogInfo(VIDEO2_SCREEN_ID, RetrieveLogInfo(VIDEO2_SCREEN_ID));
    //
    $('#loading_animation_div').slideUp();
    $('#index_div').slideDown();
    //
